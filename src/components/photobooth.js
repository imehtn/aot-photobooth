...
const stickerOptions = [
    "assets/stickers/scouts_logo.png"
];
                            ...
                            return (
                                <img
                                    ...
                                    onMouseEnter={(e) => {
                                        ...
                                        e.currentTarget.style.boxShadow = "0 30px 30px rgba(120, 172, 121, 0.45)";
                                    }}
                                    onMouseLeave={(e) => {
                                        e.currentTarget.style.transform = "scale(1)";
                                        e.currentTarget.style.boxShadow = frameThumb.boxShadowz;
                                    }}
                                    style={{
                                        ...frameThumb,
                                        transform: isSelected ? "scale(1.08)" : "scale(1)",
                                        transition: "transform 0.25s ease, box-shadow 0.25s ease",
                                        boxShadow: isSelected ? "0 12px 30px rgba(120, 172, 121, 0.45)" : frameThumb.boxShadow,
                                    }}
